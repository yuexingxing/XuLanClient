...
public class TestActivity extends BaseActivity implements OnClickListener {
	...
	public void onEventMainThread(Message msg) {
		...
		if(scanInfo.getWhat() == Constant.SCAN_DATA && scanInfo.getType().equals(Constant.SCAN_TYPE_VERIFY)){
	...
	public void checkData(String billcode){
		...
		ScanData scanData = DataUtilTools.checkScanData(Constant.SCAN_TYPE_VERIFY, billcode, dataList);
		if (scanData != null) {
