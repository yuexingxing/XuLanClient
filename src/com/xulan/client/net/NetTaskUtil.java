...
import com.xulan.client.util.MD5;
...
public class NetTaskUtil {
	...
	public static LoadTextNetTask makeTextNetTask(final String strUrl,
		...
		Logs.i("post-data",strUrl);
		Logs.i("post-data",data);
		...
		paramMap.put("appver", CommandTools.getVersionName());
		paramMap.put("timestamp", MyApplication.getInstance().sendTime);
		
		paramMap.put("token", MyApplication.getInstance().token);
	...
	public static LoadTextNetTask makeTextNetTaskData(final String strUrl,
		...
		final Map<String, String> paramMap = new HashMap<String, String>();
		paramMap.put("data", data);
		paramMap.put("appid","axp.android");
		paramMap.put("format", "json");
		paramMap.put("version", "1.0");
		paramMap.put("appver", "1.1.1");
		paramMap.put("timestamp", "2012-12-12");
